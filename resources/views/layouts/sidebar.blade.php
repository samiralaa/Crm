<html>
    ...
    <body>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 w-64 bg-gray-800 text-white transform transition-transform duration-200 ease-in-out z-50 md:static md:translate-x-0" style = "background-color: rgb(0, 165, 82)" >
            ...
            <nav class="flex-1 overflow-y-auto border-t border-gray-700 mt-1 bg-gray-800" style = "background-color: red">
                <ul>
                    ...
                    <li class="p-4 hover:bg-gray-700 flex items-center border-b border-gray-700">
                        ...
                        <a href="{{ route('calendar.index') }}">
                            <span>Calendar</span>
                            <span class="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ">{{ cache()->get('countCalenders') }}</span>
                        </a>
                    </li>
                    <li class="p-4 hover:bg-gray-700 flex items-center border-b border-gray-700">
                ...
                <ul class="mt-2 text-[#dee7f1] ml-3 text-sm">
                    <li class="text-lg font-semibold mb-3 mt-4">
                        ...
                        <a href="{{ route('reload.info') }}" class="text-blue-400 hover:text-blue-600">
                            <button onclick="window.location.href='{{ route('reload.info') }}'"
                    ...
                    <li class="flex items-center mt-1">
                        <i class="fa fa-money-bill-wave mr-2" aria-hidden="true"></i>
